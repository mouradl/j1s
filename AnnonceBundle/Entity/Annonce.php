...
class Annonce
{
     ...
     * @var string
     *
     * @ORM\Column(name="titre_ann", type="string", length=300, nullable=false)
     */
    private $titreAnn;
     ...
     * @var string
     *
     * @ORM\Column(name="disponibilite", type="text", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="prix_ann", type="integer", nullable=true)
     */
    private $prixAnn;
     ...
     * @var boolean
     *
     * @ORM\Column(name="prix_negociable", type="string", length=100, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="desc_ann", type="text", nullable=true)
     */
    private $descAnn;
     ...
     * @var string
     *
     * @ORM\Column(name="mot_cles", type="string", length=255, nullable=true)
     */
    private $motCles;
     ...
     * @var string
     *
     * @ORM\Column(name="images_ann", type="text", nullable=true)
     */
    private $imagesAnn;
     ...
     * @var string
     *
     * @ORM\Column(name="vidieo_ann", type="text", nullable=true)
     */
    private $vidieoAnn;
...
/**
     ...
     * Set mailExpiration
     *
     * @param \Tuni\AnnonceBundle\Entity\MailExpiration $mailExpiration
     * @return Annonce
     */
    public function setMailExpiration(\Tuni\AnnonceBundle\Entity\MailExpiration $mailExpiration = null)
    {
     ...
     * Get mailExpiration
     *
     * @return \Tuni\AnnonceBundle\Entity\MailExpiration 
     */
     ...
     * Set devise
     *
     * @param \Tuni\AnnonceBundle\Entity\Devise $devise
     * @return Annonce
     */
    public function setDevise(\Tuni\AnnonceBundle\Entity\Devise $devise = null)
    {
        $this->devise = $devise;
     ...
     * Get devise
     *
     * @return \Tuni\AnnonceBundle\Entity\Devise 
     */
     ...
     * Set statutAnnonce
     *
     * @param \Tuni\AnnonceBundle\Entity\StatutAnnonce $statutAnnonce
     * @return Annonce
     */
    public function setStatutAnnonce(\Tuni\AnnonceBundle\Entity\StatutAnnonce $statutAnnonce = null)
    {
     ...
     * Get statutAnnonce
     *
     * @return \Tuni\AnnonceBundle\Entity\StatutAnnonce 
     */
     ...
     * Set ville
     *
     * @param \Tuni\AnnonceBundle\Entity\Ville $ville
     * @return Annonce
     */
    public function setVille(\Tuni\AnnonceBundle\Entity\Ville $ville = null)
    {
        $this->ville = $ville;
     ...
     * Get ville
     *
     * @return \Tuni\AnnonceBundle\Entity\Ville 
     */
     ...
     * @return Annonce
     */
    public function setSousCat(\Tuni\AnnonceBundle\Entity\SousCategorie $sousCat = null)
    {
     ...
     * Get sousCat
     *
     * @return \Tuni\AnnonceBundle\Entity\SousCategorie 
     */
     ...
     * Set typeAnnonce
     *
     * @param \Tuni\AnnonceBundle\Entity\TypeAnnonce $typeAnnonce
     * @return Categorie
     */
    public function setTypeAnnonce(\Tuni\AnnonceBundle\Entity\TypeAnnonce $typeAnnonce = null)
    {
     ...
     * Get typeAnnonce
     *
     * @return \Tuni\AnnonceBundle\Entity\TypeAnnonce 
     */
    ...
    public function getFullImagePath() {
        if (null === $this->imagesAnn) {
            return null;
        }
        $images=  explode(";", $this->imagesAnn);
    ...
    public function getUploadRootDir() {
        ...
        return __DIR__ . '/../../../../web/upload/photos/'.$this->getId().'/';
    }
 
    protected function getTmpUploadRootDir() {
        // the absolute directory path where uploaded documents should be saved
        return __DIR__ . '/../../../../web/bundles/tuniadmin/theme/scripts/plupload/examples/photos/';
    }
    ...
    {   if (null === $this->imagesAnn) {
        ...
        copy($this->getTmpUploadRootDir().$image, $this->getUploadRootDir().$image);
        if (file_exists($this->getTmpUploadRootDir()))unlink($this->getTmpUploadRootDir().$image);
    ...
    {if (null === $this->imagesAnn) {
        ...
        if (file_exists($this->getUploadRootDir().$image))unlink($this->getUploadRootDir().$image);
