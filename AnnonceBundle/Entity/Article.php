...
class Article
{
 ...
 /**
     * Set page
     *
     * @param \Tuni\AnnonceBundle\Entity\Page $page
     * @return Article
     */
    public function setPage(\Tuni\AnnonceBundle\Entity\Page $page = null)
    {
        $this->page = $page;
     ...
     * Get page
     *
     * @return \Tuni\AnnonceBundle\Entity\Page 
     */
    ...
    protected function getUploadRootDir() {
        ...
        return $this->getTmpUploadRootDir()."article/";
    }
